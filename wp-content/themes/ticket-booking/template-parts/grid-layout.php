        ...
        <div class="blog-post">
            ...
            <div class="blog-content-wrapper">            
                ...
                <div class="meta no-image">
                    <?php
                        if(true===get_theme_mod('ticket_booking_enable_posts_meta_author',true)) :
                            ?>
                        ...
                        if(true===get_theme_mod('ticket_booking_enable_posts_meta_date',true)) :
                            ?>
                        ...
                        if(true===get_theme_mod('ticket_booking_enable_posts_meta_comments',true)) :
                            ?>
                        ...
                        if(is_single()){
                            ...
                            ?>
                                ...
                                <div class="post-categories">
                                    <?php esc_html_e('Categories:','ticket-booking') ?><?php the_category(); ?>
                                </div>
                            <?php
                        }
                        else{
                            the_excerpt();
                            $ticket_booking_readmore = esc_html(get_theme_mod('ticket_booking_posts_readmore_text',esc_html__('READ MORE +','ticket-booking')));
                            if(!empty($ticket_booking_readmore)) {
                                ?>
                                    <div class="read-more">
                                        <a href="<?php echo esc_url(get_permalink() ); ?>"><?php echo $ticket_booking_readmore ?></a>
                                    </div>
                                <?php
                            }
                        }
